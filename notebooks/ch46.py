...
app = marimo.App(
    width="full",
    app_title="Chapter 46: The Beginning of Christianity",
)
...
@app.cell
def _(mo):
    mo.md(r"""### Map of Biblical Canaanites""")
    return
...
def _(mo):
    mo.image(
        "https://i.dailymail.co.uk/1s/2020/05/28/16/28934148-8365839-image-a-19_1590678466469.jpg",
        rounded=True,
...
def _(mo):
    ...
    4. Then Europe had peace for a long time until Mohammed the First came upon the scene and fulfilled the works of Jesus the Nazareth.
...
@app.cell
def _(mo):
    mo.md(r"""### Diwali: Festival of Lights""")
    return
